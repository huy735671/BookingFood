...
const ProfileScreen = () => {
  ...
  const handleChooseAvatar = () => {
    // Logic to choose an avatar (e.g., from device gallery)
    // For now, you can simply simulate a placeholder change.
    setAvatar('https://placekitten.com/200/200');
  };

  const handleSaveProfile = () => {
    // Handle save logic here, without Firebase
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.avatarContainer}>
        ...
        <TouchableOpacity style={styles.cameraIcon} onPress={handleChooseAvatar}>
